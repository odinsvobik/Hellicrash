...
_respect = missionNamespace getVariable "Tom_RespectKilledBoat"; 

//["toastRequest", ["InfoTitleAndText", ["АДМИНИСТРАЦИЯ", format ["zabit:%1 hráčem:%2", _name1, _name2]]]] call ExileServer_system_network_send_broadcast;
